...
export const GOLDEN_VECTORS: GoldenCase[] = [
  ...
  { id: "GV-03", section: "A", description: "Composite ~1.50 boundary (PEP-excluded weights)", input: baseInput({ ...ALL_LOW, productScore: 3 as Score, serviceScore: 3 as Score, employmentScore: 1 as Score, professionScore: 1 as Score }), boundary: "calculator", expect: { mathBand: "Medium", compositeMin: 1.5001, compositeMax: 1.501 } },
  ...
  { id: "GV-09", section: "B", description: "Domestic PEP → Medium floor", input: baseInput({ ...ALL_LOW, pep: "Domestic" }), expect: { finalRating: "Medium", overrideIds: ["OVR-016"] } },
  ...
  { id: "GV-24", section: "E", description: "Cross-border product uplift", input: baseInput({ ...ALL_LOW, serviceScore: 3 as Score, productScore: 3 as Score }), expect: { compositeMin: 1.5 } },
  { id: "GV-25", section: "E", description: "STR filed → High floor", input: baseInput({ ...ALL_LOW, strsScore: 3 as Score, investigationsScore: 3 as Score }), expect: { finalRating: "High", overrideIds: ["OVR-010"] } },
...
export function runGoldenVector(c: GoldenCase): GoldenRunResult {
  ...
  if (c.id === "GV-07") {
    ...
    const ok = calc.mathBand === "Medium" && cram.mathBand === "High"
      && calc.composite >= 2.09 && calc.composite <= 2.112;
    return {
      id: c.id, section: c.section, description: c.description,
      passed: ok, skipped: false,
