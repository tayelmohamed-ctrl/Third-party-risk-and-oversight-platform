...
export const ZENUS_PURPOSE_CODES: ZenusPurposeCode[] = [
  ...
  { id: 9, name: "Charitable Donation", note: "C2C removed — donation to an individual is a TF/fraud typology", category: "Charity / Donation", type: "GA", flows: F(false, true, false, true, true), risk: "High", trigger: "Registered-NPO verification; TF screening; crowd-collection into one individual → decline (OS-TM-043)", changed: true },
  ...
  { id: 15, name: "Salary Transfer", category: "Payroll", type: "GA", flows: F(false, false, true, false, false), risk: "Low", trigger: "Employer verification; B2C payroll — roster-to-WPS reconciliation, ghost-employee / salary-funnel watch (OS-TM-053)", changed: true },
  { id: 16, name: "Savings / Own-Account Transfer", note: "Renamed from vague “Preferable Saving / Interest Rate Offer”", category: "Financial", type: "GA", flows: F(false, true, false, true, true), risk: "Low", trigger: "Same-name Confirmation of Payee (CoP) — hard control, mismatch = block/review; self-transfer velocity → layering pre-stage (OS-TM-041/042); on-us (Mal2Mal) self-layering / limit-evasion structuring (OS-TM-067) + internal-layering chain aggregation (OS-TM-065)", changed: true },
  { id: 17, name: "Loan to Beneficiary", category: "Loan", type: "GA", flows: F(true, false, true, true, true), risk: "High", trigger: "Informal-lending / hawala EDD on C2C; B2C loan disbursement — lending-licence hard gate, unlicensed lender = decline + escalate (OS-TM-057)", changed: true },
  ...
  { id: 26, name: "Dividends", category: "Dividend / Investment", type: "GA", flows: F(false, false, true, true, false), risk: "Medium", trigger: "B2C dividend — shareholder-registry match (hard control); dividend to a non-shareholder = hidden-ownership signal → UBO refresh (OS-TM-055)", changed: true },
  ...
  { id: 29, name: "Import / Export Settlements", category: "Trade", type: "SME", flows: F(false, true, false, true, false), risk: "High", trigger: "TBML: trade-doc reconciliation, dual-use / goods screening; B2B over/under-invoicing + 3rd-party-payment (OS-TM-059); related-party / circular-trade round-trip (OS-TM-060)", changed: true },
  ...
  { id: 32, name: "Virtual-Asset Settlement", note: "NEW — closes the crypto gap (Rain / SwiftX rails)", category: "Restricted", type: "GA", flows: F(false, false, false, false, false), risk: "Prohibited", riskNote: "*Auto-decline unless VA activity licensed & policy-approved · sanctioned-wallet exposure → block + OFAC report ≤10 bus. days; mixer exposure → High floor (OS-TM-038/021)", trigger: "*Blocked unless licensed & policy-approved", added: true },
];
...
export const ZENUS_CHANGE_LOG: ZenusChange[] = [
  ...
  { title: "Self-Transfer & C2C Scenario Pack alignment", detail: "Own-Account Transfer (#16) binds the same-name Confirmation-of-Payee hard control + self-transfer-velocity layering watch (OS-TM-041/042); Charitable Donation (#9) adds the crowd-collection-into-one-individual decline (OS-TM-043); Virtual-Asset Settlement (#32) adds the sanctioned-wallet block / mixer High-floor path (OS-TM-038/021).", tag: "Scenario pack · self/C2C" },
  { title: "Business → Individual (B2C) Scenario Pack alignment", detail: "Salary Transfer (#15) binds roster-to-WPS reconciliation + ghost-employee / salary-funnel watch (OS-TM-053); Dividends (#26) bind the shareholder-registry hard control + dividend-to-non-shareholder hidden-ownership signal (OS-TM-055); Loan to Beneficiary (#17) binds the B2C lending-licence hard gate — an unlicensed lender is declined + escalated (OS-TM-057). Commission-kickback, refund-laundering and prize-scam payouts are monitored via OS-TM-054/056/058 against the internal B2C purpose codes (guidance + monitoring only; no CRR change).", tag: "Scenario pack · B2C" },
  { title: "Business → Business (B2B) Scenario Pack alignment", detail: "Import/Export Settlements (#29) binds trade-doc reconciliation + over/under-invoicing / 3rd-party-payment detection (OS-TM-059) and the related-party / circular-trade round-trip test (OS-TM-060) — B2B is the perimeter's highest TBML surface. Dividends (#26) extend the UBO-chain-match hard control to corporate dividends (OS-TM-062). Charitable Donation (#9, B2B/CSR) binds the licensed-charity whitelist + NPO overlay (OS-TM-052). Shell-consulting fees, commission/procurement kickback and royalty/IP mispricing are monitored via OS-TM-061/063/064 against the internal B2B purpose codes (guidance + monitoring only; no CRR change). Completes the C2C·C2B·B2C·B2B matrix.", tag: "Scenario pack · B2B" },
  { title: "Mal-to-Mal (on-us) Scenario Pack alignment", detail: "On-us transfers (both parties Mal customers) add the linkage lens — same-person, same-UBO/common-control, genuine third party, collusive cluster. Own-Account Transfer (#16) binds on-us self-layering / limit-evasion structuring (OS-TM-067) + internal-layering-chain aggregation (OS-TM-065). Owner→own-business commingling (OS-TM-068), collusive cluster / internal mule ring (OS-TM-066), undeclared common-control intercompany round-trip (OS-TM-069) and the sanctioned/prohibited-node both-legs freeze (OS-TM-070) are monitored across the M2M sub-flows. On-us convenience never lowers a floor; a sanctioned/prohibited node freezes both legs; aggregate the chain, don't score hops in isolation (guidance + monitoring only; no CRR change). Completes the C2C·C2B·B2C·B2B·Mal2Mal matrix.", tag: "Scenario pack · Mal2Mal" },
];
