...
/** Investigative narrative must answer (Guidance §3.3 · FFIEC App L). */
export const NARRATIVE_FRAMEWORK = ["Who", "What", "When", "Where", "Why", "How (modus operandi)"] as const;

/** @deprecated use NARRATIVE_FRAMEWORK */
export const FFIEC_SAR_NARRATIVE = NARRATIVE_FRAMEWORK;

/** FinCEN SAR supporting documentation rules (FFIEC App L) */
export const FINCEN_SUPPORTING_DOCS = {
  excelAttachmentMaxMb: 1,
  retentionYears: 5,
  partVDescription: "Describe supporting documentation in SAR Part V — do not attach except Excel ≤1MB",
} as const;
