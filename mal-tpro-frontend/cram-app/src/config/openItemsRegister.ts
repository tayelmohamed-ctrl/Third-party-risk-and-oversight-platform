...
export const OPEN_ITEMS_REGISTER: OpenItem[] = [
  ...
  },
  {
    ...
    status: "accepted",
    decision: "Library refresh QA complete (2026-06-29) — safe-haven values validated on G1 load",
  },
  {
    id: "4",
  ...
  },
  {
    ...
    status: "accepted",
    decision: "MLRO accepted (2026-06-29): LP scoring uses ISIC Rev.5 quantitative library + legal-type register; entity sub-factors documented in exam pack",
  },
  {
    id: "6",
